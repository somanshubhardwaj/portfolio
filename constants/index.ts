...
export const projects = [
  ...
  {
    id: 5,
    title: "Hill'ffair 2024",
    text: "Developed and deployed a  web application for the annual cultural fest, Hill'ffair NITH.  Utilised Framer Motion and GSAP for smooth UI animations and effects, enhancing the app's aesthetics. ",
    backgroundUrl: "assets/benefits/card-6.svg",
    iconUrl: benefitIcon4,
    imageUrl: benefitImage2,
    href: "https://hillffair.com/",
    git: "https://hillffair.com/",
  },
  {
    id: 6,
    title: "Jira Clone",
    text: "This project is a clone of Jira, aiming to replicate some of the core features of the popular  tool. It's built using tech stack including Next.js, Convex, and TailwindCSS, providing a rich, interactive user experience. ",
    backgroundUrl: "assets/benefits/card-1.svg",
    iconUrl: benefitIcon4,
    imageUrl: benefitImage2,
    href: "https://jira-clone-sage.vercel.app/",
    git: "https://github.com/somanshubhardwaj/jira-clone",
  },
  {
    id: 7,
    title: "A Guide to Python",
    text: "A Guide to Python is a project aimed at providing comprehensive learning resources for Python programming. This guide  includes tutorials, code examples, and explanations of various Python concepts to help learners understand and master language. ",
    backgroundUrl: "assets/benefits/card-2.svg",
    iconUrl: benefitIcon4,
    imageUrl: benefitImage2,
    href: "https://aguidetopython.vercel.app/",
    git: "https://github.com/somanshubhardwaj/nuxtproject",
  },
];
